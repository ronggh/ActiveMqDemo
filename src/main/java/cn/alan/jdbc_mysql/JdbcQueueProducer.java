...
public class JdbcQueueProducer {
    //
    private final static String kActiveMqUrl = "tcp://192.168.154.101:61616";
    private final static String kQueueName = "jdbc-queue01";
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i< 3; i++){
            // 7. 创建消息
            TextMessage textMessage = session.createTextMessage("jdbc-mysql Message------ " + i);
        ...
        System.out.println("jdbc-mysql 消息发送完毕>>>>>>>");
    }
}
